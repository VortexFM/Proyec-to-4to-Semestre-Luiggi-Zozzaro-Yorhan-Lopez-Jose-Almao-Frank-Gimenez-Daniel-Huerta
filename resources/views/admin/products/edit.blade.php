...
@section('content')
    ...
    <section class="admin-header">
        <section>
            <h1 class="admin-header__title">Editar Producto</h1>
            <p class="admin-header__subtitle">Modifica los datos del producto</p>
        </section>
            ...
            <section class="product-form__main">
                ...
                <section class="admin-card">
                    ...
                    <section class="form-group">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-input" value="Camisa estampada" required>
                    </section>

                    <section class="form-group">
                        <label class="form-label" for="descripcion">Descripción *</label>
                        <textarea id="descripcion" name="descripcion" rows="5" class="form-textarea" required>Camisa de algodón con estampado exclusivo. Disponible en varias tallas.</textarea>
                    </section>
                    ...
                    <section class="form-grid">
                        ...
                        <section class="form-group">
                            ...
                            <input type="text" id="sku" name="sku" class="form-input" value="SKU-001">
                        </section>
                    </section>
                </section>
                ...
                <section class="admin-card">
                    ...
                    <section class="form-grid">
                        <section class="form-group">
                            ...
                            <input type="number" id="precio" name="precio" step="0.01" min="0" class="form-input" value="25.00" required>
                        </section>

                        <section class="form-group">
                            <label class="form-label" for="precio_oferta">Precio de oferta (opcional)</label>
                            <input type="number" id="precio_oferta" name="precio_oferta" step="0.01" min="0" class="form-input" value="20.00">
                ...
                <section class="admin-card">
                    ...
                    <section class="form-grid">
                        <section class="form-group">
                            ...
                            <input type="number" id="stock" name="stock" min="0" class="form-input" value="15" required>
                        </section>

                        <section class="form-group">
                            <label class="form-label" for="stock_minimo">Stock mínimo (alerta)</label>
                            <input type="number" id="stock_minimo" name="stock_minimo" min="0" class="form-input" value="5">
                ...
                <section class="admin-card admin-card--danger">
                    <h2 class="admin-card__title">Zona de peligro</h2>
                    <p class="form-help" style="margin-bottom: 1rem;">
                        Una vez que elimines este producto, no se puede recuperar.
                    </p>
